...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.fin'
        db.alter_column(u'projects_project', 'fin', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 19, 0, 0)))

        # Changing field 'Project.inicio'
        db.alter_column(u'projects_project', 'inicio', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 19, 0, 0)))
